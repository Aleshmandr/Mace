...
namespace Mace
{
    public class CollectionBinder : ComponentBinder
    {
        ...
        {
            currentItems[index] = itemPicker.ReplaceItem(oldValue, newValue, currentItems[index], Container);
        }
        ...
        private void RemoveItem(int index)
        {
            ...
            itemPicker.DisposeItem(item);
        }

        private void InsertItem(int index, IViewModel value)
        {
            ViewModelComponent newItem = itemPicker.SpawnItem(value, Container);
